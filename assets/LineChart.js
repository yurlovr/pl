...
export default {
  ...
  mounted () {
    ...
    let gradientFill1 = this.$refs.canvas.getContext('2d').createLinearGradient(0, 0, 0, 400);
    gradientFill1.addColorStop(0, '#0099FF');
    gradientFill1.addColorStop(1, 'rgba(0, 153, 255, 0)');

    let gradientFill2 = this.$refs.canvas.getContext('2d').createLinearGradient(0, 0, 0, 400);
