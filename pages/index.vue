<template>
    <div class="main-page">
        ...
        <BeachSliderArea
            ...
            :data="$store.state.beachSliderData"
            :areaData="mostPopularBeachesAreaData"
        />
        ...
        <div class="main-page__white-wrapper">
            <BeachSliderArea
                :data="familyData"
                :areaData="familyAreaData"
                class="main-page__family-rest"
            />
        </div>
        <BeachEvents
            :data="$store.state.beachEventsSliderData"
            :areaData="beachEventsData"
        />
        <ChooseBeach />
        ...
        <YouNeedThis />
        <BeachSliderArea
            class="main-page__hotels"
            :data="$store.state.hotelData"
            :areaData="$store.state.hotelAreaData"
        />
