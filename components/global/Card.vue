  ...
  <div class="custom-card" v-if="data">
    <div class="custom-card__pic-area">
      <a :href="data.mainLink ? data.mainLink : '#'" class="custom-card__link"
        ...
        <img loading="lazy" :src="data.pic" v-show="this.picLoaded" alt="Фото" class="custom-card__pic" @load="picLoaded = true">
        <img loading="lazy" v-show="!this.picLoaded" class="custom-card__pic"
      ...
      <div class="custom-card__temp-area" v-if="data.tempWater != undefined && showTemp != false">
        <img loading="lazy" src="~/static/pics/global/svg/temper_big.svg" alt="Температура" class="big">
        <img loading="lazy" src="~/static/pics/global/svg/temper_small.svg" alt="Температура" class="small">
      ...
      <img loading="lazy" class="custom-card__paid" v-if="data.paid" src="~/static/pics/global/svg/paid.svg" alt="Платный">
      <button class="custom-card__visited" @click="updateVisited()" v-if="this.data && this.data.eventId"
        ...
        <div class="custom-card__visited__round">
          <img loading="lazy" src="~/static/pics/global/svg/tick.svg" v-show="visited">
        </div>
    ...
    <div class="custom-card__info-area position-relative" :class="{ event: data.beach }">
      ...
      <div class="custom-card__date-area" v-if="data.date">
        <img loading="lazy" src="~/static/pics/global/svg/calendar.svg" alt="Дата">
      ...
      <div class="custom-card__subtitle-area">
        ...
        <a :href="data.beachLink ? data.beachLink : '#'"
          ...
          <span>
            <img loading="lazy" :style="{ 'height': data.beach ? '9px' : '11px', 'margin-bottom': '3px' }"
