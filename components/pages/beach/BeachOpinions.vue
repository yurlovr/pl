	...
	<section class="two-part-layout__card beach-page__opinions">
		...
		<div class="pagination-wrapper">
			<div class="custom-pagination">
				<button @click="mySwiperMain.slideTo(i)" class="custom-pagination-bullet" v-for="(b,i) in data.length" :class="{ 'custom-pagination-bullet-active' : i == activeIndex }"></button>
			</div>
		</div>
	</section>
</template>
